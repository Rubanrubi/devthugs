...
{{--                <img class="switcher-logo" src="{{asset('assets/img/logos/logo/bulkit-core.svg') }}" alt="">--}}
        ...
        <div id="is-cloned" class="navbar-menu">
                            ...
                            <div class="container">
                                <div class="columns">
                                    ...
                                    <div class="column">
                                        ...
                                        <p class="is-cta">As a Bulkit customer, you get some free goodies on Css
                                            Ninja.</p>
                                        <p class="is-cta">
                                            <a href="#" target="_blank" class="button btn-align mega-btn primary-btn">Learn
                                                more</a>
                                        </p>
                                    </div>
                                </div>
            ...
            <div class="navbar-end">
                ...
                <!-- Navbar item -->
                <a class="navbar-item is-slide is-centered-tablet" href="#" target="_blank">
                    Docs
                </a>
