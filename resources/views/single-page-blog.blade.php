...
@section('title') Single Page @endsection
            ...
            <div class="column is-8">
                ...
                <div class="is-single-post">
                    <div class="featured-post-image">
                        </img src="https://via.placeholder.com/1200x300" data-demo-src="{{asset('/img/demo/posts/post-1.jpg')}}" alt="">
                        <div class="post-date">
                    ...
                    <div class="featured-post-body">
                        ...
                        <div class="post-author">
                            <div class="post-author-avatar">
                                </img src="https://via.placeholder.com/250x250" alt="" data-demo-src="{{asset('/img/avatars/carolin.png')}}'">
                            </div>
                        ...
                        <div class="related-posts">
                            ...
                            <div class="columns">
                                ...
                                <div class="column is-6">
                                    <div class="card blog-grid-item is-related">
                                        <div class="card-image">
                                            </img class="item-featured-image" src="https://via.placeholder.com/1200x300" data-demo-src="{{asset('/img/demo/posts/post-2.jpg')}}" alt="">
                                            <div class="post-date">
                                                <div class="post-date-inner">
                                                    <span>Oct</span>
                                                    <span>22</span>
                                ...
                                <div class="column is-6">
                                    <div class="card blog-grid-item is-related">
                                        <div class="card-image">
                                            </img class="item-featured-image" src="https://via.placeholder.com/1200x300" data-demo-src="{{asset('/img/demo/posts/post-5.jpg')}}" alt="">
                                            <div class="post-date">
                                                <div class="post-date-inner">
                                                    <span>Oct</span>
                                                    <span>12</span>
                                ...
                                <div class="media">
                                    <figure class="media-left">
                                        <p class="image is-48x48">
                                            </img src="https://via.placeholder.com/250x250" alt="" data-demo-src="{{asset('/img/avatars/elie.jpg')}}">
                                        </p>
                                    </figure>
                                    <div class="media-content">
                                        ...
                                        <div class="media">
                                            <figure class="media-left">
                                                <p class="image is-48x48">
                                                    </img src="https://via.placeholder.com/250x250" alt="" data-demo-src="{{asset('/img/avatars/thomas.jpg')}}">
                                                </p>
                                            </figure>
                                            <div class="media-content">
                                                <div class="content">
                                        ...
                                        <div class="media">
                                            <figure class="media-left">
                                                <p class="image is-48x48">
                                                    </img src="https://via.placeholder.com/250x250" alt="" data-demo-src="{{asset('/img/avatars/sally.jpg')}}">
                                                </p>
                                            </figure>
                                            <div class="media-content">
                                                <div class="content">
                        ...
                        <div class="blog-sidebar-posts-inner">
                            ...
                            <a href="#" class="blog-sidebar-post">
                                <div class="post-image">
                                    </img src="https://via.placeholder.com/1600x900" alt="" data-demo-src="{{asset('/img/demo/posts/thumb-1.jpg')}}">
                                </div>
                            ...
                            <a href="#" class="blog-sidebar-post">
                                <div class="post-image">
                                    </img src="https://via.placeholder.com/1600x900" alt="" data-demo-src="{{asset('/img/demo/posts/thumb-2.jpg')}}">
                                </div>
                                <div class="post-content">
                            ...
                            <a href="#" class="blog-sidebar-post">
                                <div class="post-image">
                                    </img src="https://via.placeholder.com/1600x900" alt="" data-demo-src="{{asset('/img/demo/posts/thumb-3.jpg')}}">
                                </div>
                                <div class="post-content">
                                    <h3>Let me tell you why jQuery is not dead yet</h3>
                                    <div class="meta">
                                        </img src="https://via.placeholder.com/250x250" alt="" data-demo-src="{{asset('/img/avatars/nick.jpg')}}">
                            ...
                            <a href="#" class="blog-sidebar-post">
                                <div class="post-image">
                                    </img src="https://via.placeholder.com/1600x900" alt="" data-demo-src="{{asset('/img/demo/posts/thumb-4.jpg')}}">
                                </div>
                                <div class="post-content">
                                    <h3>Feeling alone in front of customer design choices?</h3>
                                    <div class="meta">
                                        </img src="https://via.placeholder.com/250x250" alt="" data-demo-src="{{asset('/img/avatars/henry.jpg')}}">
